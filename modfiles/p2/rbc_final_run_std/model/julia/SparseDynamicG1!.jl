...
g1_v[2]=(-(y[12]^(1-params[2])*exp((-y[14]))*get_power_deriv(y[2]*exp((-y[14])),params[2],1)));
g1_v[3]=(-(100*(-(1/y[3]))));
g1_v[4]=(-(params[6]*1/y[5]));
g1_v[5]=(-((params[2]*y[19]/y[10]+(1-params[3])*exp((-y[22])))*1/y[17]));
g1_v[6]=1;
...
g1_v[13]=(-(100*1/y[11]));
g1_v[14]=(-((y[2]*exp((-y[14])))^params[2]*get_power_deriv(y[12],1-params[2],1)));
g1_v[15]=y[9]*params[4]/((params[5]-y[12])*(params[5]-y[12]))-(1-params[2])*(-y[11])/(y[12]*y[12]);
g1_v[16]=(-(1/y[12]));
g1_v[17]=1/y[13];
g1_v[18]=(-((1-params[3])*y[2]*(-exp((-y[14])))));
g1_v[19]=(-(y[12]^(1-params[2])*get_power_deriv(y[2]*exp((-y[14])),params[2],1)*y[2]*(-exp((-y[14])))));
g1_v[20]=1;
g1_v[21]=(-100);
g1_v[22]=1;
g1_v[23]=1;
g1_v[24]=(-((params[2]*y[19]/y[10]+(1-params[3])*exp((-y[22])))*(-y[9])/(y[17]*y[17])));
