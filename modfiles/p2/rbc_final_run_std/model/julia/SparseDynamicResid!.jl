...
@inbounds begin
    residual[1] = (1/params[1]) - ((params[2]*y[19]/y[10]+(1-params[3])*exp((-y[22])))*y[9]/y[17]);
    residual[2] = (y[10]+y[9]-(1-params[3])*y[2]*exp((-y[14]))) - (y[11]);
    residual[3] = (y[11]) - (y[12]^(1-params[2])*(y[2]*exp((-y[14])))^params[2]);
