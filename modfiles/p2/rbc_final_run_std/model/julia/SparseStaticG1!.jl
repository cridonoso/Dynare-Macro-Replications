...
g1_v[5]=(-(y[4]^(1-params[2])*exp((-y[6]))*get_power_deriv(y[2]*exp((-y[6])),params[2],1)));
g1_v[6]=(-(params[2]/y[2]));
g1_v[7]=(-1);
g1_v[8]=1;
g1_v[9]=(-((1-params[2])*1/y[4]));
g1_v[10]=(-((y[2]*exp((-y[6])))^params[2]*get_power_deriv(y[4],1-params[2],1)));
...
g1_v[15]=(-(y[2]*(1-params[3])*(-exp((-y[6])))));
g1_v[16]=(-(y[4]^(1-params[2])*get_power_deriv(y[2]*exp((-y[6])),params[2],1)*y[2]*(-exp((-y[6])))));
g1_v[17]=1;
g1_v[18]=(-100);
g1_v[19]=1;
g1_v[20]=1;
