...
@inbounds begin
    residual[1] = (1/params[1]) - ((1-params[3])*exp((-y[6]))+params[2]*y[3]/y[2]);
    residual[2] = (y[1]+y[2]-exp((-y[6]))*(1-params[3])*y[2]) - (y[3]);
    residual[3] = (y[3]) - (y[4]^(1-params[2])*(exp((-y[6]))*y[2])^params[2]);
