...
g1_v[5]=(-1)/(y[9]*y[9]);
g1_v[6]=(-(y[11]*(1-params[3])*(-1)/(y[9]*y[9])/y[13]));
g1_v[7]=1;
g1_v[8]=1;
g1_v[9]=(-1);
g1_v[10]=(-(1/y[9]*(1-params[3])/y[13]));
g1_v[11]=1;
g1_v[12]=(-1);
g1_v[13]=(-(1/y[13]));
g1_v[14]=(-(params[1]*1/y[17]*y[21]^(1-params[3])*params[3]*exp(y[22])*get_power_deriv(y[12],params[3]-1,1)));
g1_v[15]=1;
g1_v[16]=params[5]/((1-y[13])*(1-y[13]))-(-(1/y[9]*(1-params[3])*y[11]))/(y[13]*y[13]);
g1_v[17]=(-(exp(y[14])*y[4]^params[3]*get_power_deriv(y[13],1-params[3],1)));
