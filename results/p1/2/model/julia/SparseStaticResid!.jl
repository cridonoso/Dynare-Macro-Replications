...
@inbounds begin
    ...
    residual[6] = (y[1]) - (y[2]+y[4]*(1-params[2])-y[4]);
    residual[7] = (y[4]) - (y[4]*(1-params[2])+y[5]);
    residual[8] = (y[2]) - (y[6]*y[4]^params[3]*y[3]^(1-params[3]));
    residual[9] = (log(y[6])) - (log(y[6])*params[4]+x[1]);
    residual[10] = (y[7]) - (y[2]/y[3]);
end
    return nothing
end
