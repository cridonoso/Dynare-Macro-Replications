...
\begin{table}[H]
    ...
    \midrule
    $\sigma_c / \sigma_y$ & 4.7030 & 0.5700 \\
$\sigma_{dk} / \sigma_y$ & 6.7796 & 2.3300 \\
$\sigma_n / \sigma_y$ & 3.0603 & 0.3600 \\
$\sigma_{r} / \sigma_{y/n}$ & 1.0000 & 0.5400 \\
$\sigma_g / \sigma_y$ & 5.0218 & 1.7600 \\
$\sigma_y$ & 0.1784 & 0.0200 \\
\text{corr}(y/n, n) & -0.9581 & 0.9500 \\
    \bottomrule
    \end{tabular}
\end{table}
