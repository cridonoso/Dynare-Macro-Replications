...
$N$ & 1369 & 1369 \\
$\gamma$ & 3.4703 & 2.9900 \\
$\lambda$ & 0.0030 & 0.0040 \\
$\sigma_{\varepsilon}$ & 0.0119 & 0.0180 \\
$\bar{g}$ & 182.8569 & 186.0000 \\
$\rho$ & 0.9074 & 0.9600 \\
$\sigma_{\mu}$ & 0.0068 & 0.0200 \\
    \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \midrule
    $c_t / y_t$ & 0.5629 & 0.5600 \\
$g_t / y_t$ & 0.1792 & 0.1770 \\
$dk_t / y_t$ & 0.2579 & 0.2600 \\
$k_{t+1} / y_t$ & 10.80 & 10.54 \\
$n_t$ & 301.17 & 315.60 \\
    \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \midrule
    $\sigma_c / \sigma_y$ & 6.0770 & 0.5700 \\
$\sigma_{dk} / \sigma_y$ & 9.9853 & 2.3300 \\
$\sigma_n / \sigma_y$ & 3.8464 & 0.3600 \\
$\sigma_{r} / \sigma_{y/n}$ & 1.0000 & 0.5400 \\
$\sigma_g / \sigma_y$ & 0.0000 & 1.7600 \\
$\sigma_y$ & 0.1492 & 0.0200 \\
