...
$\sigma_{\varepsilon}$ & 0.0109 & 0.0180 \\
$\bar{g}$ & 208.6579 & 186.0000 \\
$\rho$ & 0.9960 & 0.9600 \\
...
\begin{table}[H]
    ...
    \midrule
    $c_t / y_t$ & 0.5341 & 0.5600 \\
$g_t / y_t$ & 0.2065 & 0.1770 \\
$dk_t / y_t$ & 0.2595 & 0.2600 \\
$k_{t+1} / y_t$ & 10.56 & 10.54 \\
$n_t$ & 301.70 & 315.60 \\
    \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \midrule
    $\sigma_c / \sigma_y$ & 6.0340 & 0.5700 \\
$\sigma_{dk} / \sigma_y$ & 9.3785 & 2.3300 \\
$\sigma_n / \sigma_y$ & 3.7386 & 0.3600 \\
$\sigma_{r} / \sigma_{y/n}$ & 1.0000 & 0.5400 \\
$\sigma_g / \sigma_y$ & 0.0000 & 1.7600 \\
$\sigma_y$ & 0.1392 & 0.0200 \\
\text{corr}(y/n, n) & -0.9984 & 0.9500 \\
    \bottomrule
    \end{tabular}
\end{table}
